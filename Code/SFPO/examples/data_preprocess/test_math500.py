...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/mnt/shared-storage-user/wangziyan-p/code/verl/data/math500')
    ...
    data_source = '/mnt/shared-storage-user/wangziyan-p/code/verl/data/MATH-500/'
