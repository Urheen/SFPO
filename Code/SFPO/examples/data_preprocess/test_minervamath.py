...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/mnt/shared-storage-user/wangziyan-p/code/verl/data/minervamath')
    parser.add_argument('--hdfs_dir', default=None)
    parser.add_argument('--template_type', type=str, default='base')

    args = parser.parse_args()

    data_source = '/mnt/shared-storage-user/wangziyan-p/code/verl/data/minervamath-raw'
